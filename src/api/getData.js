...
// export const adminList = data => fetch('/formget', data);
export const adminList = () => fetch('/formget');
/**
 * 管理员数量
 */
...
export const getFoods = () => fetch('/formget');
/**
 * 获取食品数量
 */
...
export const getMenu = () => fetch('/formget');
/**
 * 获取menu详情
 */
 ...
 * export const updateFood = data => fetch('/shopping/v2/updatefood', data, 'POST')
 */
export const formget = data => fetch('/formget', data, 'Post');
