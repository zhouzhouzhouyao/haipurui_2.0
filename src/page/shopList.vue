        ...
        <div class="table_container">
                ...
                <el-table-column type="expand">
                  <template slot-scope="props">
                    <el-form label-position="left" inline class="demo-table-expand">
                      <el-form-item label="训练场 ID">
                        <span>{{ props.row.name }}</span>
                      </el-form-item>
                      <el-form-item label="训练场">
                        <span>{{ props.row.address }}</span>
                      </el-form-item>
                      <el-form-item label="训练场介绍">
            ...
            <el-dialog title="修改评论信息" v-model="dialogFormVisible">
                <el-form :model="selectTable">
                    ...
                    <el-form-item label="训练场地址" label-width="100px">
                        <el-autocomplete
                    ...
                    <el-form-item label="训练场介绍" label-width="100px">
                    ...
                    <el-form-item label="训练场图片" label-width="100px">
                        <el-upload
